...
module gameLogic{
	...
	export function checkHorizontal(board : any, row : any, col : any, color : any){
	...
	export function checkBackSlash(board : any, row : any, col : any, color : any){
		var sameColors = [[row, col]];
		var i : any;
		for(i = 1; i < 15; i++){
	...
	export function checkForwardSlash(board : any, row : any, col : any, color : any){
		var sameColors = [[row, col]];
		var i : any;
		for(i = 1; i < 15; i++){
	...
	export function checkVertical(board : any, row : any, col : any, color : any){
		var sameColors = [[row, col]];
		var i : any;
		for(i = 1; i < 15; i++){
	...
	export function getWinner(winningSequence : any){
	...
	export function getWinningSequence(board : any, row : any, col : any, color : any) {
		var winningSeuqnece : any = [];
